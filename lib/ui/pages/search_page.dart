            ...
            builder: (_, searchState) {
              ...
              if (searchState is SearchStateSuccess) {
                return searchState.items.isEmpty
                    ? Center(child: Text('Tidak Ada Hasil',style: blackTextFont.copyWith(fontSize: 18)))
                    : Column(
                        children: searchState.items
                            .map((e) => RestaurantList(e, onTap: () {
                              context.read<PageBloc>().add(GoToRestaurantDetailPage(e, widget.nameUser));
                            }))
                            .toList());
              }
              return Center(child: Text('Masukkan Nama Restoran', style: blackTextFont.copyWith(fontSize: 16)));
            },
          );
  }
  ...
  Container header(BuildContext context) {
    return Container(
            margin: EdgeInsets.fromLTRB(
                defaultMargin, 8, defaultMargin, 12),
            child: Row(
